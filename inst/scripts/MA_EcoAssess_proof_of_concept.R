...
url <- 'https://services1.arcgis.com/hGdibHYSPO59RG1h/arcgis/rest/services/Massachusetts_Property_Tax_Parcels/FeatureServer/0'             # new REST URL, as of 2 Apr 2026


layer <- arc_open(url)
poly <- arc_select(layer, fields = 'OWNER1', filter_geom = st_as_sfc(bbox))

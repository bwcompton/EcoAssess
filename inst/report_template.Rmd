...
project area, while scores for "best" are the mean scores for the top 50% of cells in the project area. Scores in the top 10% are in bold. 
...
Percentiles^[Percentiles are expected to be somewhat different in the final version.] for the ecoConnect score are based on comparison 
with scores of random squares in the rest of the 
region, state, and HUC 8 watershed. https://umassdsl.org/data/ecoConnect

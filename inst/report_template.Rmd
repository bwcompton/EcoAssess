...
The project area is `r params$acres` acres in `r params$state`, `r params$huc`


It has `r params$ttt` cells

### Index of ecological Integrity

**Type** | **`r params$table.IEI.levels[1]`** | **`r params$table.IEI.levels[2]`** | **`r params$table.IEI.levels[3]`** | **`r params$table.IEI.levels[4]`**
---|---|---|---|---
...
project area, while scores for "best" are the mean scores for cells in the top quartile
(25%) within the project area. Scores in the top 10% are in bold. 
...
connectivity. The ecoConnect score is compared in percentiles with the rest of the region, state, or HUC 8 watershed. For project
areas that cross state or watershed boundaries, percentiles are based on the sites majority state or watershed, listed first.

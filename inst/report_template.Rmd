...
For both IEI and ecoConnect, reported scores for "mean" are the mean for the project area, while scores for "best" are the mean of 
the top quartile in the project area. Percentiles ("top" or "bottom") are based on a comparison with a large sample of
random 100 acre squares across the Northeast. Scores in the top 10% are in bold.

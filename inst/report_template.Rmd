...
connectivity. Percentiles for the ecoConnect score are based on comparison with scores of random squares in the rest of the region, state, and HUC 8 watershed. 

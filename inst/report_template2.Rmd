...
-----|---|---
`r params$table.IEI.levels[1]` | `r params$table.IEI[1]`
`r params$table.IEI.levels[2]` | `r params$table.IEI[2]`
`r params$table.IEI.levels[3]` | `r params$table.IEI[3]`
`r params$table.IEI.levels[4]` | `r params$table.IEI[4]`
...
**Connect** | **Score** |
-----|---|---
`r params$table.connect.levels[1]` | `r params$table.connect[1]` | 
`r params$table.connect.levels[2]` | `r params$table.connect[2]` | 
`r params$table.connect.levels[3]` | `r params$table.connect[3]` | 
`r params$table.connect.levels[4]` | `r params$table.connect[4]` | 

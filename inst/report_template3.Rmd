...
**`r params$table.IEI.levels[1]`** | **`r params$table.IEI.levels[2]`** | **`r params$table.IEI.levels[3]`** | **`r params$table.IEI.levels[4]`**
---|---|---|---
`r params$table.IEI[1]` | `r params$table.IEI[2]` | `r params$table.IEI[3]` | `r params$table.IEI[4]`

The _Index of Ecological Integrity_ (IEI), is an estimate of the ecological integrity---the ability of a site
...
**`r params$table.connect.levels[1]`** | **`r params$table.connect.levels[2]`** | **`r params$table.connect.levels[3]`** | **`r params$table.connect.levels[4]`**
---|---|---|---
`r params$table.connect[1]` | `r params$table.connect[2]` | `r params$table.connect[3]` | `r params$table.connect[4]`

_ecoConnect_ provides a regional multi-scale ecosystem-based estimate of regional connectivity throughout the Northeast. ecoConnect is independent of pre-defined conservation targets, connecting sites with high IEI throughout the landscape based on ecological systems, development, roads, and bridges.
